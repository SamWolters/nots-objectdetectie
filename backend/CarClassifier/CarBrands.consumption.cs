...
namespace Classifiers
{
    public partial class CarBrands
    {
        ...
        private static PredictionEngine<ModelInput, ModelOutput> CreatePredictEngine() {
            ...
            Stream resourceStream = assembly.GetManifestResourceStream("CarClassifier.CarBrands.mlnet");
            ITransformer mlModel = mlContext.Model.Load(resourceStream, out var _);
        ...
        public static IOrderedEnumerable<KeyValuePair<string, float?>> GetSortedScoresWithLabels(ModelOutput result)
        {
            ...
            Dictionary<string, float?> labledScores = new();
