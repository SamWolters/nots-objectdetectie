...
class WebcamCapture extends Component<WebcamCaptureProps, WebcamCaptureState> {
  ...
  drawBoxesOnCanvas = (ctx: CanvasRenderingContext2D, predictions: any[], aspectX: number, aspectY: number) => {
      ...
      <div className="container">
        ...
        <div className="row justify-content-center">
          <div className="col-12 col-sm-6">
            {this.state.showCamera && (
              <button onClick={this.handleCaptureButtonClick}>Capture</button>
            )}
